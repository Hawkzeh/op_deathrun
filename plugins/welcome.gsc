...
init( modVersion )
{
	braxi\_dvar::addDvar( "welcome_message1", "welcome_message1", "Welcome to ^1oP ^7Death Run server!", "", "", "string" );
	braxi\_dvar::addDvar( "welcome_message2", "welcome_message2", "^3Visit www.op-clan.freeclanforum.com", "", "", "string" );
