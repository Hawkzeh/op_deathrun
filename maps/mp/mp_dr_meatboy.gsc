...
sniperroomdel()
{
	...
	sniper_portalfx playsound("rock");
	sniper_portal hide();
...
heliroomdel()
{
	...
	level.trig_heli = getent("trigger_helicopter","targetname");
...
secrettele()
{
	trig_actisecret=getent("trig_actisecret","targetname");
	secret_destination=getent("secret_destination","targetname");
	
	trig_actisecret waittill("trigger", player);
	trig_actisecret delete();
...
secretgun()
{
	snipergun = getent("snipergun","targetname");
	back_map = getent("back_map","targetname");
	
	snipergun waittill("trigger",player);
	snipergun delete();
	...
	player switchToWeapon( "remington700_mp" );
	wait 2;
	player SetOrigin( back_map.origin );
	player setplayerangles( back_map.angles );
}
